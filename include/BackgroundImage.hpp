...
class BattlefieldIMG : public Util::GameObject {

public:
    BattlefieldIMG() : GameObject(
              std::make_unique<Util::Image>("../assets/sprites/background/BattlefieldIMG.png"), -9) {
        m_Transform.scale = glm::vec2(1, 1.2);
        m_Transform.translation = glm::vec2{0,190};
    }
